...
def searchClique_2(NN_ADJ_red,ADJ_sign,nNanoInput,nDrugInput,nChemicalInput,nDiseaseInput,nano,drug,chemical,disease,nanoOrigin,drugOrigin,diseaseOrigin,chemicalOrigin,queryInput,elemName):
...
def clique4(NN_ADJ,ADJ_sign,nano,drug,chemical,disease,elemName):
